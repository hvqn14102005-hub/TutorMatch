          ...
          <div className="w-full md:w-2/5 bg-primary p-12 text-white">
            ...
            <div className="mt-16">
              ...
              <div className="flex gap-4">
                {['FB', 'IG', 'YT'].map(social => (
                  <div key={social} className="w-12 h-12 rounded-2xl bg-white/10 flex items-center justify-center hover:bg-white/20 cursor-pointer transition-colors font-bold text-sm">
                    {social}
                  </div>
                ))}
              </div>
